...
package com.jongor_software.android.sunshine.service;
...
public class SunshineService extends IntentService {
    ...
    public static class AlarmReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            Intent forwardIntent = new Intent(context, SunshineService.class);
            forwardIntent.putExtra(
                    SunshineService.LOCATION_QUERY_EXTRA,
                    forwardIntent.getStringExtra(SunshineService.LOCATION_QUERY_EXTRA));
